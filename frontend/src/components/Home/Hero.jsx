...
const Hero =()=>{
    return <div className = "h-[75vh] flex flex-col md:flex-row items-center justify-center">
        <div className = " w-full mb-12 md:mb-0 lg:w-3/6 flex-col items-center lg: items-start justify-center">
        <h1 className="text-4 xl font-semibold text-yellow-100 text-centerlg:text-left ">
        ...
        <p className="mt-4 text-xl text-zinc-300 text-center lg:text-left">
            ...
            <img src = "./bookstoreee.png" alt = "Bookstore"/>
        </div>
        </div>
